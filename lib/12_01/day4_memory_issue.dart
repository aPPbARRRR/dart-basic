...
class SomeClass {
	static const String someVarStaticConst = 'problem'; // data에 프로그램 실행시 올라감. 클래스 자체의 변수로 올라감.
	static final String someVarStaticFinal = 'problem'; // final과 달리 프로그램 실행시 data에 올라감. static으로 인해 모든 인스턴스에서 해당 변수를 공유해야하기 때문.
  static String someVarStatic = 'asdfas'; // data에 프로그램 실행시 올라감. 클래스 자체의 변수로 올라감.
